...
//    @PreAuthorize("hasAuthority('ASSET_OWNER_READ')")
    @GetMapping
...
//    @PreAuthorize("hasAuthority('ASSET_OWNER_CREATE')")
    @PostMapping
    @SecurityRequirement(name = "bearerAuth")
    public ResponseEntity<?> save(@RequestBody @Valid AssetOwnerDto dto) {
        return ResponseEntity.ok(service.save(dto));
    }

//    @PreAuthorize("hasAuthority('ASSET_OWNER_UPDATE')")
    @PutMapping("/{id}")
    @SecurityRequirement(name = "bearerAuth")
    public ResponseEntity<?> update(@PathVariable Long id, @RequestBody @Valid AssetOwnerDto dto) {
        return ResponseEntity.ok(service.update(id, dto));
    }

//    @PreAuthorize("hasAuthority('ASSET_OWNER_DELETE')")
    @DeleteMapping("/{id}")
    @SecurityRequirement(name = "bearerAuth")
